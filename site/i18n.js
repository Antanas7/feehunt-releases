  ...
  en: {
    download: {
      ...
      walk: {
        ...
        s1: { title: "A file will start downloading", body: "Your browser will save FeeHunt-Setup-v1.9.exe to your Downloads folder. It's a small file (~80 MB) and takes about 30 seconds on most connections." },
        s2: { title: "Double-click the downloaded file", body: "Open your Downloads folder and double-click FeeHunt-Setup-v1.9.exe." },
        s3: {
  ...
  lt: {
    ...
    download: {
      ...
      walk: {
        ...
        s1: { title: "Pradės siųstis failas", body: "Naršyklė išsaugos FeeHunt-Setup-v1.9.exe į jūsų Atsisiuntimų (Downloads) aplanką. Tai nedidelis failas (~80 MB), atsisiunčia per maždaug 30 sekundžių." },
        s2: { title: "Du kartus spustelėkite atsisiųstą failą", body: "Atidarykite Atsisiuntimų aplanką ir dukart spustelėkite FeeHunt-Setup-v1.9.exe." },
        s3: {
