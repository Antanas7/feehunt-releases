...
const FH_I18N = {
  en: {
    ...
    home: {
      ...
      heroButtons: ["Start Free Trial", "Download Beta"],
      ...
      badges: ["14-Day Free Trial", "Cancel Anytime", "Privacy-First", "Works Locally"],
      securityStrip: [["Bank-level security", "Local and encrypted"], ["No servers. No tracking.", "You stay in control."], ["Calm Gmail protection", "Signals before surprises"]],
      socialProof: "Join 1,000+ users taking control of Gmail and finances.",
      ...
      pricingHeading: ["Pricing preview", "Simple monthly plans with a 14-day free trial."],
      plans: [["Basic", "For one Gmail account.", ["1 Gmail account", "1 license key", "14-day free trial", "Cancel anytime"], "Choose Basic"], ["Family", "For up to three Gmail accounts.", ["Up to 3 Gmail accounts", "1 license key", "14-day free trial", "Cancel anytime"], "Choose Family"]],
      pricingNotice: "No hidden fees. Cancel anytime with one click.",
      start: ["Start now", "Start your free trial and take control of your subscriptions and inbox.", "Start Free Trial", "Download Beta"],
    },
    pricing: {
      title: "Pricing | FeeHunt",
      description: "Simple FeeHunt pricing with Basic and Family plans.",
      hero: ["Pricing", "Simple Pricing for a Cleaner Inbox and Fewer Forgotten Subscriptions.", "Start with a 14-day free trial. Choose the plan that matches how many Gmail accounts you want to connect. Cancel anytime.", "You stay in control: start with a trial, review the plan, and cancel before public billing enforcement begins.", "Start Free Trial", "Upgrade Plan"],
      plans: [["Basic Plan", "Best for individuals who want to review one Gmail account and reduce recurring subscription waste.", ["14-day free trial", "1 Gmail account", "1 license key", "Subscription detection", "Payment control alerts", "Promotional inbox cleanup", "Local processing", "Cancel anytime"], "Start Basic Trial", "Manage / Cancel Plan"], ["Family Plan", "Best for households, couples, and families who want to manage multiple Gmail accounts under one license.", ["14-day free trial", "Up to 3 Gmail accounts", "1 license key", "Subscription detection", "Payment control alerts", "Promotional inbox cleanup", "Local processing", "Cancel anytime"], "Start Family Trial", "Manage / Cancel Plan"]],
      faqHeading: ["Billing FAQ", "Honest pricing, clear cancellation."],
      faq: [["Is there a free trial?", "Yes. Both Basic and Family plans include a 14-day free trial."], ["When will I be charged?", "After the 14-day trial ends, your selected plan becomes active unless you cancel before the trial ends."], ["Can I cancel anytime?", "Yes. FeeHunt provides a clear subscription management path through Stripe Billing Portal."], ["Are there hidden fees?", "No. FeeHunt uses simple monthly pricing with no hidden fees."], ["Can I change plans later?", "Yes. Plan upgrades and billing self-service are handled through the customer portal."]],
    },
    signup: {
      title: "Start Free Trial | FeeHunt",
      description: "Create your FeeHunt account and start a 14-day free trial. No credit card required.",
      hero: {
      ...
      form: {
        ...
        plan: "Plan",
        planTrial: "14-day free trial - 1 Gmail account",
    ...
    login: {
      ...
      footer: { signup: "New to FeeHunt? <a class=\"text-link\" href=\"signup.html\">Start a free 14-day trial</a>." },
    },
    success: {
...
FH_I18N.lt = {
  ...
  home: {
    ...
    badges: ["14 dienu bandymas", "Galima atsaukti bet kada", "Privatumas pirmiausia", "Veikia lokaliai"],
    ...
    pricingHeading: ["Kainu perziura", "Paprasti menesiniai planai su 14 dienu bandymu."],
    plans: [["Basic", "Vienai Gmail paskyrai.", ["1 Gmail paskyra", "1 licencijos raktas", "14 dienu bandymas", "Galima atsaukti bet kada"], "Pasirinkti Basic"], ["Family", "Iki triju Gmail paskyru.", ["Iki 3 Gmail paskyru", "1 licencijos raktas", "14 dienu bandymas", "Galima atsaukti bet kada"], "Pasirinkti Family"]],
  ...
  pricing: {
    ...
    hero: ["Kainodara", "Paprasta kaina svaresnei pasto dezutei ir maziau pamirstu prenumeratu.", "Pradekite nuo 14 dienu bandymo. Pasirinkite plana pagal Gmail paskyru skaiciu. Atsaukti galite bet kada.", "Kontrole lieka jums: pradekite nuo bandymo, perziurekite plana ir atsaukite pries mokama laikotarpi.", "Pradeti bandyma", "Atnaujinti plana"],
    plans: [["Basic planas", "Tinka vienam zmogui, norinciam perziureti viena Gmail paskyra.", ["14 dienu bandymas", "1 Gmail paskyra", "1 licencijos raktas", "Prenumeratu aptikimas", "Mokejimu kontrole", "Reklaminio pasto tvarkymas", "Vietinis apdorojimas", "Galima atsaukti bet kada"], "Pradeti Basic bandyma", "Valdyti / atsaukti plana"], ["Family planas", "Tinka seimai ar kelioms Gmail paskyroms su viena licencija.", ["14 dienu bandymas", "Iki 3 Gmail paskyru", "1 licencijos raktas", "Prenumeratu aptikimas", "Mokejimu kontrole", "Reklaminio pasto tvarkymas", "Vietinis apdorojimas", "Galima atsaukti bet kada"], "Pradeti Family bandyma", "Valdyti / atsaukti plana"]],
    faqHeading: ["Atsiskaitymo DUK", "Aiski kaina ir aiskus atsaukimas."],
    faq: [["Ar yra nemokamas bandymas?", "Taip. Basic ir Family planai turi 14 dienu bandyma."], ["Kada busiu apmokestintas?", "Po 14 dienu bandymo pasirinktas planas taps aktyvus, nebent atsauksite pries pabaiga."], ["Ar galiu atsaukti bet kada?", "Taip. Prenumerata valdoma per Stripe Billing Portal."], ["Ar yra pasleptu mokesciu?", "Ne. FeeHunt naudoja paprasta menesine kainodara."], ["Ar galesiu keisti plana?", "Taip. Plano keitimas ir atsiskaitymo savitarna vyksta klientu portale."]],
  },
  signup: {
    title: "Pradėti bandymą | FeeHunt",
    description: "Sukurkite FeeHunt paskyrą ir pradėkite 14 dienų bandymą.",
    hero: {
      eyebrow: "14 dienų nemokamas bandymas",
    ...
    form: {
      ...
      plan: "Planas",
      planTrial: "14 dienų nemokamas bandymas - 1 Gmail paskyra",
  ...
  login: {
    ...
    footer: { signup: "Naujas FeeHunt vartotojas? <a class=\"text-link\" href=\"signup.html\">Pradėkite nemokamą 14 dienų bandymą</a>." },
  },
  success: {
...
function buildDerivedLanguage(code) {
  ...
  base.home.pricingHeading[1] = `Simple monthly plans with a 14-day ${trial}.`;
  base.home.plans[0][2][2] = `14-day ${trial}`;
  base.home.plans[1][2][2] = `14-day ${trial}`;
  ...
  base.signup.hero.eyebrow = `14-day ${trial}`;
...
const FH_LANGUAGE_OVERRIDES = {
  no: {
    home: {
      ...
      badges: ["14 dagers prøveperiode", "Avbryt når som helst", "Personvern først", "Kjører lokalt"],
      ...
      pricingHeading: ["Prisoversikt", "Enkle månedsplaner med 14 dagers prøveperiode."],
    ...
    pricing: {
      ...
      hero: ["Priser", "Enkle priser for en ryddigere innboks og færre glemte abonnementer.", "Start med en 14 dagers prøveperiode. Velg planen som passer antall Gmail-kontoer. Avbryt når som helst.", "Du beholder kontrollen: start med prøveperiode, se planen og avbryt før betalt periode starter.", "Start prøveperiode", "Oppgrader plan"],
      plans: [["Basic-plan", "For én person som vil gå gjennom én Gmail-konto.", ["14 dagers prøveperiode", "1 Gmail-konto", "1 lisensnøkkel", "Abonnementssøk", "Betalingskontroll", "Opprydding i reklamepost", "Lokal behandling", "Avbryt når som helst"], "Start Basic-prøve", "Administrer / avbryt plan"], ["Family-plan", "For familier eller flere Gmail-kontoer med én lisens.", ["14 dagers prøveperiode", "Opptil 3 Gmail-kontoer", "1 lisensnøkkel", "Abonnementssøk", "Betalingskontroll", "Opprydding i reklamepost", "Lokal behandling", "Avbryt når som helst"], "Start Family-prøve", "Administrer / avbryt plan"]],
      faqHeading: ["Faktura-FAQ", "Tydelige priser og enkel avbestilling."],
      faq: [["Finnes det gratis prøveperiode?", "Ja. Basic og Family inkluderer 14 dagers prøveperiode."], ["Når blir jeg belastet?", "Etter prøveperioden blir valgt plan aktiv med mindre du avbryter før den slutter."], ["Kan jeg avbryte når som helst?", "Ja. Abonnementet kan administreres via Stripe Billing Portal."], ["Finnes det skjulte gebyrer?", "Nei. FeeHunt bruker enkel månedspris."], ["Kan jeg endre plan senere?", "Ja. Planendringer og fakturaadministrasjon håndteres i kundeportalen."]],
    },
    signup: {
      title: "Start prøveperiode | FeeHunt",
      description: "Opprett FeeHunt-konto og start 14 dagers prøveperiode.",
      hero: { eyebrow: "14 dagers prøveperiode", title: "Få FeeHunt-nøkkelen din.", lead: "Skriv inn e-posten — vi sender FeeHunt-nøkkelen så du kan aktivere Windows-appen. Ingen kort kreves." },
      form: { email: "Gmail- eller e-postadresse", plan: "Plan", planTrial: "14 dagers prøveperiode - 1 Gmail-konto", planBasic: "Basic - 1 Gmail-konto", planFamily: "Family - opptil 3 Gmail-kontoer", submit: "Send FeeHunt-nøkkelen", note: "Ingen kort kreves. FeeHunt lagrer ikke Gmail-innhold på lisensserveren." },
  ...
  es: {
    home: {
      ...
      badges: ["Prueba de 14 días", "Cancela cuando quieras", "Privacidad primero", "Funciona localmente"],
      ...
      pricingHeading: ["Vista de precios", "Planes mensuales simples con prueba de 14 días."],
    ...
    pricing: {
      ...
      hero: ["Precios", "Precios simples para una bandeja más limpia y menos suscripciones olvidadas.", "Empieza con una prueba de 14 días. Elige el plan según cuántas cuentas Gmail quieres conectar. Cancela cuando quieras.", "Tú mantienes el control: empieza con una prueba, revisa el plan y cancela antes del periodo de pago.", "Iniciar prueba", "Mejorar plan"],
      plans: [["Plan Basic", "Para una persona que quiere revisar una cuenta Gmail.", ["Prueba de 14 días", "1 cuenta Gmail", "1 clave de licencia", "Detección de suscripciones", "Control de pagos", "Limpieza de correos promocionales", "Procesamiento local", "Cancela cuando quieras"], "Iniciar Basic", "Gestionar / cancelar plan"], ["Plan Family", "Para familias o varias cuentas Gmail con una licencia.", ["Prueba de 14 días", "Hasta 3 cuentas Gmail", "1 clave de licencia", "Detección de suscripciones", "Control de pagos", "Limpieza de correos promocionales", "Procesamiento local", "Cancela cuando quieras"], "Iniciar Family", "Gestionar / cancelar plan"]],
      faqHeading: ["FAQ de facturación", "Precio claro y cancelación sencilla."],
      faq: [["¿Hay prueba gratis?", "Sí. Basic y Family incluyen una prueba de 14 días."], ["¿Cuándo se cobra?", "Después de la prueba de 14 días, tu plan se activa salvo que canceles antes."], ["¿Puedo cancelar cuando quiera?", "Sí. La suscripción se gestiona con Stripe Billing Portal."], ["¿Hay cargos ocultos?", "No. FeeHunt usa precios mensuales simples."], ["¿Puedo cambiar de plan?", "Sí. Los cambios de plan y facturación se gestionan en el portal de cliente."]],
    },
    signup: {
      title: "Iniciar prueba | FeeHunt",
      description: "Crea tu cuenta FeeHunt e inicia una prueba de 14 días.",
      hero: { eyebrow: "Prueba de 14 días", title: "Obtén tu clave FeeHunt.", lead: "Introduce tu email — te enviaremos la clave FeeHunt para activar la app de Windows. No se requiere tarjeta." },
      form: { email: "Dirección Gmail o email", plan: "Plan", planTrial: "Prueba de 14 días - 1 cuenta Gmail", planBasic: "Basic - 1 cuenta Gmail", planFamily: "Family - hasta 3 cuentas Gmail", submit: "Enviar mi clave FeeHunt", note: "No se requiere tarjeta. FeeHunt no guarda contenido de Gmail en el servidor de licencias." },
  ...
  de: {
    home: {
      ...
      badges: ["14 Tage Testphase", "Jederzeit kündbar", "Datenschutz zuerst", "Läuft lokal"],
      ...
      pricingHeading: ["Preisübersicht", "Einfache Monatspläne mit 14 Tagen Testphase."],
    ...
    pricing: {
      ...
      hero: ["Preise", "Einfache Preise für einen saubereren Posteingang und weniger vergessene Abonnements.", "Starte mit 14 Tagen Testphase. Wähle den Plan passend zur Anzahl deiner Gmail-Konten. Jederzeit kündbar.", "Du behältst die Kontrolle: starte mit einer Testphase, prüfe den Plan und kündige vor dem kostenpflichtigen Zeitraum.", "Testphase starten", "Plan upgraden"],
      plans: [["Basic-Plan", "Für eine Person, die ein Gmail-Konto prüfen möchte.", ["14 Tage Testphase", "1 Gmail-Konto", "1 Lizenzschlüssel", "Abo-Erkennung", "Zahlungskontrolle", "Aufräumen von Werbe-E-Mails", "Lokale Verarbeitung", "Jederzeit kündbar"], "Basic testen", "Plan verwalten / kündigen"], ["Family-Plan", "Für Familien oder mehrere Gmail-Konten mit einer Lizenz.", ["14 Tage Testphase", "Bis zu 3 Gmail-Konten", "1 Lizenzschlüssel", "Abo-Erkennung", "Zahlungskontrolle", "Aufräumen von Werbe-E-Mails", "Lokale Verarbeitung", "Jederzeit kündbar"], "Family testen", "Plan verwalten / kündigen"]],
      faqHeading: ["Abrechnungs-FAQ", "Klare Preise und einfache Kündigung."],
      faq: [["Gibt es eine kostenlose Testphase?", "Ja. Basic und Family enthalten 14 Tage Testphase."], ["Wann wird abgerechnet?", "Nach der Testphase wird dein gewählter Plan aktiv, sofern du nicht vorher kündigst."], ["Kann ich jederzeit kündigen?", "Ja. Das Abonnement wird über das Stripe Billing Portal verwaltet."], ["Gibt es versteckte Gebühren?", "Nein. FeeHunt nutzt einfache monatliche Preise."], ["Kann ich später den Plan wechseln?", "Ja. Planwechsel und Abrechnung werden im Kundenportal verwaltet."]],
    },
    signup: {
      title: "Testphase starten | FeeHunt",
      description: "Erstelle dein FeeHunt-Konto und starte 14 Tage Testphase.",
      hero: { eyebrow: "14 Tage Testphase", title: "Erhalte deinen FeeHunt-Schlüssel.", lead: "Gib deine E-Mail ein — wir senden dir den FeeHunt-Schlüssel, damit du die Windows-App aktivieren kannst. Keine Karte erforderlich." },
      form: { email: "Gmail- oder E-Mail-Adresse", plan: "Plan", planTrial: "14 Tage Testphase - 1 Gmail-Konto", planBasic: "Basic - 1 Gmail-Konto", planFamily: "Family - bis zu 3 Gmail-Konten", submit: "FeeHunt-Schlüssel senden", note: "Keine Karte erforderlich. FeeHunt speichert keine Gmail-Inhalte auf dem Lizenzserver." },
  ...
  fr: {
    home: {
      ...
      badges: ["Essai de 14 jours", "Annulation à tout moment", "Confidentialité d'abord", "Fonctionne localement"],
      ...
      pricingHeading: ["Aperçu des tarifs", "Plans mensuels simples avec essai de 14 jours."],
    ...
    pricing: {
      ...
      hero: ["Tarifs", "Des tarifs simples pour une boîte mail plus claire et moins d'abonnements oubliés.", "Commencez avec un essai de 14 jours. Choisissez le plan adapté au nombre de comptes Gmail. Annulez à tout moment.", "Vous gardez le contrôle : commencez par un essai, vérifiez le plan et annulez avant la période payante.", "Démarrer l'essai", "Changer de plan"],
      plans: [["Plan Basic", "Pour une personne qui veut vérifier un compte Gmail.", ["Essai de 14 jours", "1 compte Gmail", "1 clé de licence", "Détection des abonnements", "Contrôle des paiements", "Nettoyage des emails promotionnels", "Traitement local", "Annulation à tout moment"], "Essayer Basic", "Gérer / annuler le plan"], ["Plan Family", "Pour les familles ou plusieurs comptes Gmail avec une seule licence.", ["Essai de 14 jours", "Jusqu'à 3 comptes Gmail", "1 clé de licence", "Détection des abonnements", "Contrôle des paiements", "Nettoyage des emails promotionnels", "Traitement local", "Annulation à tout moment"], "Essayer Family", "Gérer / annuler le plan"]],
      faqHeading: ["FAQ facturation", "Prix clairs et annulation simple."],
      faq: [["Y a-t-il un essai gratuit ?", "Oui. Basic et Family incluent un essai de 14 jours."], ["Quand serai-je facturé ?", "Après l'essai, le plan choisi devient actif sauf si vous annulez avant la fin."], ["Puis-je annuler à tout moment ?", "Oui. L'abonnement se gère via Stripe Billing Portal."], ["Y a-t-il des frais cachés ?", "Non. FeeHunt utilise une tarification mensuelle simple."], ["Puis-je changer de plan plus tard ?", "Oui. Les changements de plan et la facturation sont gérés dans le portail client."]],
    },
    signup: {
      title: "Démarrer l'essai | FeeHunt",
      description: "Créez votre compte FeeHunt et démarrez un essai de 14 jours.",
      hero: { eyebrow: "Essai de 14 jours", title: "Obtenez votre clé FeeHunt.", lead: "Entrez votre email — nous envoyons votre clé FeeHunt pour activer l'application Windows. Aucune carte requise." },
      form: { email: "Adresse Gmail ou email", plan: "Plan", planTrial: "Essai de 14 jours - 1 compte Gmail", planBasic: "Basic - 1 compte Gmail", planFamily: "Family - jusqu'à 3 comptes Gmail", submit: "Envoyer ma clé FeeHunt", note: "Aucune carte requise. FeeHunt ne stocke pas le contenu Gmail sur le serveur de licences." },
  ...
  en: {
    download: {
      ...
      walk: {
        ...
        s1: { title: "A file will start downloading", body: "Your browser will save FeeHunt-Setup-v1.3.exe to your Downloads folder. It's a small file (~80 MB) and takes about 30 seconds on most connections." },
        s2: { title: "Double-click the downloaded file", body: "Open your Downloads folder and double-click FeeHunt-Setup-v1.3.exe." },
        s3: {
    ...
    privacy: {
      ...
      description: "FeeHunt privacy policy draft.",
...
mergeTranslation(FH_STATIC_PAGE_TRANSLATIONS.lt, {
  ...
  privacy: { title: "Privatumo politika | FeeHunt", description: "FeeHunt privatumo politikos projektas.", hero: ["Privatumo politika", "Privatumas nuo pat pradžių.", "FeeHunt sukurtas remiantis vietiniu apdorojimu, minimaliu duomenų rinkimu ir vartotojo kontrole."], intro: ["Atnaujinta:", " 2026-05-19", "Šis projektas paruoštas produkto planavimui ir prieš viešą paleidimą turi būti peržiūrėtas."], sections: [["Apžvalga", ["FeeHunt yra privatumą sauganti darbalaukio programa, padedanti aptikti prenumeratas, finansinės rizikos laiškus, reklaminį triukšmą ir būsimas sukčiavimo rizikas."]], ["Vietinis apdorojimas", ["FeeHunt apdoroja Gmail skenavimo rezultatus vartotojo kompiuteryje. Analizė, rezultatai, nustatymai ir licencijos metaduomenys lieka vartotojo įrenginyje, nebent būsima funkcija aiškiai nurodytų kitaip."]], ["Gmail prieiga", ["FeeHunt naudoja Google OAuth prieigą. Vartotojas patvirtina prieigą per Google. FeeHunt neprašo ir nesaugo Gmail slaptažodžių."]], ["Vietoje saugomi duomenys", ["OAuth autorizacijos tokenas", "Skenavimo rezultatai", "Vartotojo nustatymai", "Valymo pasirinkimai", "Vietiniai licencijos metaduomenys"]], ["Minimalus duomenų rinkimas", ["FeeHunt turėtų rinkti tik minimalius duomenis, reikalingus veikimui, licencijavimui, patikimumui ir klientų aptarnavimui."]], ["Duomenys neparduodami", ["FeeHunt neparduoda vartotojų duomenų ir neturėtų parduoti, nuomoti ar keistis Gmail duomenimis, rezultatais ar paskyros informacija."]], ["Mokėjimai ir licencijavimas", ["Viešo paleidimo licencijavimas ir mokėjimai gali reikalauti paskyros, atsiskaitymo ir licencijos duomenų. Mokėjimus turi tvarkyti patikimas tiekėjas, pvz., Stripe. FeeHunt neturėtų saugoti kortelių duomenų."]], ["Vartotojo kontrolė", ["Atšaukti Gmail prieigą per Google paskyrą", "Ištrinti vietinius FeeHunt failus iš kompiuterio", "Atšaukti mokamą prenumeratą per aiškų savitarnos kelią"]], ["Kontaktai", ["Privatumo klausimais rašykite "]]]},
  terms: { title: "Naudojimo sąlygos | FeeHunt", description: "FeeHunt naudojimo sąlygų projektas.", hero: ["Naudojimo sąlygos", "FeeHunt naudojimo sąlygos.", "Šios sąlygos aprašo produkto naudojimą, beta ribojimus, atsiskaitymą, atšaukimą ir vartotojo atsakomybę."], intro: ["Atnaujinta:", " 2026-05-19", "Šis projektas paruoštas produkto planavimui ir prieš viešą paleidimą turi būti peržiūrėtas."], sections: [["Sąlygų priėmimas", ["Naudodami FeeHunt sutinkate su šiomis naudojimo sąlygomis. Jei nesutinkate, produkto nenaudokite."]], ["Produkto aprašymas", ["FeeHunt yra darbalaukio programa, padedanti peržiūrėti Gmail prenumeratas, finansinės rizikos laiškus, reklaminį triukšmą ir būsimas saugumo rizikas.", "FeeHunt teikia aptikimo ir organizavimo įrankius, bet negarantuoja, kad aptiks kiekvieną prenumeratą, mokėjimo problemą, reklamą ar sukčiavimą."]], ["Beta programinė įranga", ["FeeHunt beta versijose gali būti klaidų, nebaigtų funkcijų ir besikeičiančio elgesio. Vartotojai turi atidžiai peržiūrėti rezultatus prieš Gmail veiksmus."]], ["Vartotojo atsakomybė", ["Peržiūrėti aptiktus laiškus prieš veiksmus", "Suprasti, kad archyvavimas, trynimas ir kiti Gmail veiksmai paveikia tikrus laiškus", "Išlaikyti prieigą prie Gmail paskyros", "Saugoti OAuth failus, tokenus, licencijos raktus ir vietinius duomenis"]], ["Gmail autorizacija", ["FeeHunt naudoja Google OAuth Gmail prieigai. Vartotojas gali atšaukti prieigą Google paskyros nustatymuose."]], ["Prenumeratos ir atsiskaitymas", ["Basic: €5.90/mėn.", "Family: €9.90/mėn.", "14 dienų nemokamas bandymas", "Galima atšaukti bet kada", "Viešas mokamas taikymas turi prasidėti tik tada, kai veikia checkout, klientų portalas ir atšaukimo srautai."]], ["Atšaukimas", ["Vartotojai turi galėti atšaukti mokamas prenumeratas per aiškų savitarnos kelią. Prieiga lieka aktyvi iki apmokėto laikotarpio pabaigos, nebent nurodyta kitaip."]], ["Netinkamas naudojimas", ["Vartotojai negali naudoti FeeHunt įstatymų pažeidimui, Gmail piktnaudžiavimui ar neteisėtai prieigai prie paskyrų ar infrastruktūros."]], ["Atsakomybės ribojimas", ["FeeHunt yra produktyvumo ir el. pašto peržiūros įrankis. FeeHunt neatsako už praleistas prenumeratas, mokėjimo perspėjimus, vartotojo sprendimus ar vartotojo inicijuotus Gmail veiksmus."]], ["Sąlygų keitimai", ["FeeHunt gali atnaujinti šias sąlygas prieš ir po viešo paleidimo. Toliau naudodami produktą sutinkate su atnaujintomis sąlygomis."]], ["Kontaktai", ["Dėl šių sąlygų rašykite "]]]},
});
...
["no", "es", "de", "fr"].forEach((code) => {
  ...
  mergeTranslation(FH_STATIC_PAGE_TRANSLATIONS[code], {
    faqPage: {
      ...
      items: [["How does FeeHunt work?", "FeeHunt connects through Google OAuth and scans recent Gmail messages for subscriptions, renewals, invoices, failed payments, promotions, and risk signals."], ["Is my email private?", "FeeHunt is designed as a privacy-first local desktop app. Email analysis happens on your computer."], ["Can I cancel anytime?", "Yes. FeeHunt supports clear subscription management and cancellation."], ["Which Gmail accounts are supported?", "FeeHunt is designed for Gmail accounts connected through Google OAuth."], ["What happens after the free trial?", "After the 14-day trial, the selected paid plan becomes active unless you cancel before the trial ends."], ["How many Gmail accounts can I connect?", "Basic supports 1 Gmail account. Family supports up to 3 Gmail accounts."]],
    },
...
const FH_FINAL_TRANSLATION_PATCHES = {
  lt: {
    ...
    home: {
      ...
      badges: ["14 dienų bandymas", "Galima atšaukti bet kada", "Privatumas pirmiausia", "Veikia lokaliai"],
      ...
      pricingHeading: ["Kainų peržiūra", "Paprasti mėnesiniai planai su 14 dienų bandymu."],
      plans: [["Basic", "Vienai Gmail paskyrai.", ["1 Gmail paskyra", "1 licencijos raktas", "14 dienų bandymas", "Galima atšaukti bet kada"], "Pasirinkti Basic"], ["Family", "Iki trijų Gmail paskyrų.", ["Iki 3 Gmail paskyrų", "1 licencijos raktas", "14 dienų bandymas", "Galima atšaukti bet kada"], "Pasirinkti Family"]],
    ...
    pricing: {
      title: "Kainodara | FeeHunt",
      description: "Paprasta FeeHunt kainodara su Basic ir Family planais.",
      hero: ["Kainodara", "Paprasta kaina švaresnei pašto dėžutei ir mažiau pamirštų prenumeratų.", "Pradėkite nuo 14 dienų bandymo. Pasirinkite planą pagal Gmail paskyrų skaičių. Atšaukti galite bet kada.", "Kontrolė lieka jums: pradėkite nuo bandymo, peržiūrėkite planą ir atšaukite prieš mokamą laikotarpį.", "Pradėti bandymą", "Atnaujinti planą"],
      plans: [["Basic planas", "Tinka vienam žmogui, norinčiam peržiūrėti vieną Gmail paskyrą.", ["14 dienų bandymas", "1 Gmail paskyra", "1 licencijos raktas", "Prenumeratų aptikimas", "Mokėjimų kontrolė", "Reklaminio pašto tvarkymas", "Vietinis apdorojimas", "Galima atšaukti bet kada"], "Pradėti Basic bandymą", "Valdyti / atšaukti planą"], ["Family planas", "Tinka šeimai ar kelioms Gmail paskyroms su viena licencija.", ["14 dienų bandymas", "Iki 3 Gmail paskyrų", "1 licencijos raktas", "Prenumeratų aptikimas", "Mokėjimų kontrolė", "Reklaminio pašto tvarkymas", "Vietinis apdorojimas", "Galima atšaukti bet kada"], "Pradėti Family bandymą", "Valdyti / atšaukti planą"]],
      faqHeading: ["Atsiskaitymo DUK", "Aiški kaina ir aiškus atšaukimas."],
      faq: [["Ar yra nemokamas bandymas?", "Taip. Basic ir Family planai turi 14 dienų bandymą."], ["Kada būsiu apmokestintas?", "Po 14 dienų bandymo pasirinktas planas taps aktyvus, nebent atšauksite prieš pabaigą."], ["Ar galiu atšaukti bet kada?", "Taip. Prenumerata valdoma per Stripe Billing Portal."], ["Ar yra paslėptų mokesčių?", "Ne. FeeHunt naudoja paprastą mėnesinę kainodarą."], ["Ar galėsiu keisti planą?", "Taip. Plano keitimas ir atsiskaitymo savitarna vyksta klientų portale."]],
    },
    signup: {
      title: "Pradėti bandymą | FeeHunt",
      description: "Sukurkite FeeHunt paskyrą ir pradėkite 14 dienų bandymą.",
      hero: { eyebrow: "14 dienų nemokamas bandymas", title: "Gaukite FeeHunt raktą.", lead: "Įveskite el. paštą — atsiųsime jūsų FeeHunt raktą, kad galėtumėte aktyvuoti Windows programą. Kortelės nereikia." },
      form: { email: "Gmail arba el. pašto adresas", plan: "Planas", planTrial: "14 dienų nemokamas bandymas - 1 Gmail paskyra", planBasic: "Basic - 1 Gmail paskyra", planFamily: "Family - iki 3 Gmail paskyrų", submit: "Atsiųsti FeeHunt raktą", note: "Kortelės nereikia. FeeHunt licencijų serveryje nesaugo Gmail laiškų turinio." },
      footer: { haveKey: "Jau turite raktą? <a class=\"text-link\" href=\"login.html\">Aktyvuokite jį prisijungimo puslapyje</a>." },
    },
    success: {
    ...
    download: {
      ...
      walk: {
        ...
        s1: { title: "Pradės siųstis failas", body: "Naršyklė išsaugos FeeHunt-Setup-v1.3.exe į jūsų Atsisiuntimų (Downloads) aplanką. Tai nedidelis failas (~80 MB), atsisiunčia per maždaug 30 sekundžių." },
        s2: { title: "Du kartus spustelėkite atsisiųstą failą", body: "Atidarykite Atsisiuntimų aplanką ir dukart spustelėkite FeeHunt-Setup-v1.3.exe." },
        s3: {
    ...
    privacy: {
      ...
      description: "FeeHunt privatumo politikos projektas.",
      ...
      intro: ["Atnaujinta:", " 2026-05-19", "Šis projektas paruoštas produkto planavimui ir prieš viešą paleidimą turi būti peržiūrėtas."],
    ...
    terms: {
      ...
      description: "FeeHunt naudojimo sąlygų projektas.",
  ...
  fr: {
    home: {
      ...
      plans: [["Basic", "Pour un compte Gmail.", ["1 compte Gmail", "1 cle de licence", "Essai de 14 jours", "Annulation a tout moment"], "Choisir Basic"], ["Family", "Pour jusqu'a trois comptes Gmail.", ["Jusqu'a 3 comptes Gmail", "1 cle de licence", "Essai de 14 jours", "Annulation a tout moment"], "Choisir Family"]],
...
function applyLegal(text, key) {
  ...
  page.sections.forEach(([heading, rows], index) => {
    const h2 = document.createElement("h2");
    h2.textContent = heading;
    legal.append(h2);
    const listSection = key === "privacy" ? [3, 7].includes(index) : [3].includes(index);
    if (listSection) {
