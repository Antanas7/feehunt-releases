...
LICENSE_TRANSLATIONS = {
    "en": {
        ...
        "senders.apply_now_preview_some": "{count} email(s) from unwanted senders in your last scan.",
        "senders.apply_now_preview_none": "No emails from unwanted senders in your last scan.",
        "senders.apply_now_button": "🗑️ Move those {count} email(s) to Trash now",
        "senders.apply_now_done": "Moved {count} email(s) to Gmail Trash.",
    ...
    "lt": {
        ...
        "senders.apply_now_preview_none": "Paskutiniame skenavime laiškų iš nepageidaujamų siuntėjų nerasta.",
        "senders.apply_now_button": "🗑️ Perkelti tuos {count} laišk(-us) į šiukšlinę dabar",
        "senders.apply_now_done": "Į Gmail šiukšlinę perkelta laiškų: {count}.",
