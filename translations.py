...
LICENSE_TRANSLATIONS = {
    "en": {
        ...
        "senders.apply_now_preview_none": "No emails from unwanted senders in your last scan — but the button below also searches Gmail directly.",
    ...
    "lt": {
        ...
        "senders.apply_now_preview_none": "Paskutiniame skenavime nieko nerasta, bet mygtukas žemiau papildomai tiesiogiai paieško Gmail dabar.",
