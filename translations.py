TRANSLATIONS = {
    "en": {
        ...
        "dashboard.metric_safety": "Is it real?",
        "dashboard.metric_safety_help": "Emails worth a second look before you trust them. Open 'Is it real?' to review them — FeeHunt never acts on them for you.",
        ...
        "sidebar.deactivate_license": "Sign out",
        ...
        "sidebar.deactivate_confirm": "Yes, sign out",
        ...
        "promotions.missed_hint": "💡 Don't see an unwanted sender here? You decide what's junk — add them to your unwanted list and FeeHunt will handle them automatically next scan.",
        ...
        "bulk.select_hint": "Tip: tick a few emails above to act on several at once. Or use each email's own actions below.",
        ...
        "settings.auto_scan_weekly": "Weekly",
        ...
        "subscription.opened_website": "Opened {service_name}. Sign in and look for Billing or Subscription settings to cancel.",
    ...
    "lt": {
        ...
        "dashboard.metric_safety": "Ar tai tikra?",
        "dashboard.metric_safety_help": "Laiškai, verti antro žvilgsnio prieš jais pasitikint. Atidaryk 'Ar tai tikra?' juos peržiūrėti — FeeHunt už tave nieko nedaro.",
        ...
        "sidebar.deactivate_license": "Atsijungti",
        ...
        "sidebar.deactivate_confirm": "Taip, atsijungti",
        ...
        "promotions.missed_hint": "💡 Nematote kažkurio nepageidaujamo siuntėjo? Jūs sprendžiate, kas šlamštas — pridėkite jį į nepageidaujamų sąrašą, ir kitą skenavimą FeeHunt sutvarkys automatiškai.",
        ...
        "bulk.select_hint": "Patarimas: pažymėk kelis laiškus viršuje, kad atliktum veiksmą su keliais iškart. Arba naudok kiekvieno laiško veiksmus žemiau.",
        ...
        "settings.auto_scan_weekly": "Kartą per savaitę",
        ...
        "subscription.opened_website": "Atidaryta {service_name}. Prisijunkite ir ieškokite Billing arba Subscription nustatymų, kad atšauktumėte.",
...
LICENSE_TRANSLATIONS = {
    "en": {
        ...
        "scan.failed_note": "{count} emails could not be read this time (a brief Gmail or connection hiccup). Scan again to retry them.",
        ...
        "senders.page_lead": "One place to tell FeeHunt which senders to always protect, and which ones it keeps missing so the next scan recognises them as junk.",
        "senders.protected_title": "🛡️ Protected senders",
        "senders.protected_caption": "FeeHunt will NEVER touch emails from these senders — even if they're on your unwanted list. Good for your bank, employer, family, important services.",
        ...
        "senders.removed": "Removed from list.",
    ...
    "lt": {
        ...
        "scan.failed_note": "{count} laiškų šįkart nepavyko perskaityti (trumpas Gmail ar ryšio trikdis). Skenuokite dar kartą, kad pabandytų iš naujo.",
        ...
        "senders.page_lead": "Viena vieta nurodyti FeeHunt, kuriuos siuntėjus visada saugoti, ir kuriuos jis vis praleidžia — kad kitas skenavimas atpažintų juos kaip šlamštą.",
        "senders.protected_title": "🛡️ Saugomi siuntėjai",
        "senders.protected_caption": "FeeHunt NIEKADA nelies laiškų iš šių siuntėjų — net jei jie yra nepageidaujamų sąraše. Tinka jūsų bankui, darbdaviui, šeimai, svarbioms paslaugoms.",
        ...
        "senders.removed": "Pašalinta iš sąrašo.",
...
AI_GUIDANCE_TRANSLATIONS = {
    "en": {
        ...
        "safe_action.explain.direct_cancel": "FeeHunt found a cancellation link inside this email. The button opens it directly — FeeHunt does not cancel for you.",
        ...
        "safe_action.open_direct_cancel": "Cancel now →",
        ...
        "wizard.offer": "Not sure how to cancel? FeeHunt can walk you through it step by step.",
        "wizard.start": "🧭 Help me cancel this",
        "wizard.title": "Cancelling {service}",
        "wizard.step_label": "Step {n} of {total}",
        "wizard.s1.body": "FeeHunt found a possible subscription from **{service}**. I'll guide you through cancelling it in a few short steps. Nothing in your Gmail changes without your confirmation.",
        "wizard.s2.body": "Open the right page below, do the steps in your browser, then come back here.",
        ...
        "wizard.s3.body": "On the page, look for: **Account / Profile → Billing or Subscription → Cancel**. If asked for a reason, you can pick any. Cancellations are usually confirmed by email.",
        "wizard.s3.prepaid_note": "Some services are prepaid (credits / one-time packs) and have no recurring charge — if you find no \"Cancel\" option, there's likely nothing to cancel; just stop buying more.",
        "wizard.s4.body": "Cancelled? You can delete this email so it stops cluttering your inbox. It moves to Gmail Trash and can be restored for 30 days.",
        "wizard.s4.delete": "I cancelled — delete this email",
        "wizard.back": "← Back",
        "wizard.next": "Next →",
        "wizard.close": "Done",
    },
    "lt": {
        ...
        "safe_action.explain.direct_cancel": "FeeHunt rado atšaukimo nuorodą šiame laiške. Mygtukas ją atidaro tiesiogiai — FeeHunt neatšaukia už jus.",
        ...
        "safe_action.open_direct_cancel": "Atšaukti dabar →",
        ...
        "wizard.offer": "Nežinai, kaip atšaukti? FeeHunt gali pravesti žingsnis po žingsnio.",
        "wizard.start": "🧭 Padėk atšaukti šią prenumeratą",
        "wizard.title": "Atšaukiame {service}",
        "wizard.step_label": "Žingsnis {n} iš {total}",
        "wizard.s1.body": "FeeHunt rado galimą prenumeratą iš **{service}**. Padėsiu ją atšaukti per kelis žingsnius. Tavo Gmail nebus keičiamas be tavo patvirtinimo.",
        "wizard.s2.body": "Atidaryk tinkamą puslapį žemiau, atlik veiksmus naršyklėje ir grįžk čia.",
        ...
        "wizard.s3.body": "Puslapyje ieškok: **Account / Paskyra → Billing arba Subscription → Cancel / Atšaukti**. Jei prašoma priežasties — gali pasirinkti bet kurią. Atšaukimas paprastai patvirtinamas el. laišku.",
        "wizard.s3.prepaid_note": "Kai kurios paslaugos yra prepaid (kreditai / vienkartiniai paketai) ir neturi pasikartojančio mokesčio — jei nerandi 'Cancel/Atšaukti', greičiausiai nėra ko atšaukti; tiesiog nebepirk daugiau.",
        "wizard.s4.body": "Atšaukei? Gali ištrinti šį laišką, kad nebetrukdytų. Jis perkeliamas į Gmail šiukšlinę ir atstatomas 30 dienų.",
        "wizard.s4.delete": "Atšaukiau — ištrinti šį laišką",
        "wizard.back": "← Atgal",
        "wizard.next": "Toliau →",
        "wizard.close": "Baigta",
    },
...
ACTION_FIRST_TRANSLATIONS = {
    "en": {
        ...
        "check.manual_heading": "Check a message yourself",
        ...
        "check.sender_about": "About this sender",
        "check.sender_domain": "The email really comes from the domain **{domain}**.",
        "check.sender_legit": "This is **{brand}**'s official domain — it looks genuine.",
        "check.sender_personal": "This is a personal mailbox ({domain}) — a person sent it, not a company. Judge it by the content.",
        "check.sender_unknown": "FeeHunt doesn't have this sender in its list of known brands, so it can't confirm it's the official **{name}**. But the address shows no impersonation or lookalike tricks. If in doubt, go straight to the official website yourself instead of using links in the email.",
        "check.sender_caution": "The address itself has suspicious signs (see above) — be careful.",
        "check.advice_heading": "💡 What you can do",
        "check.advice_promotional": "This looks like a promotional email. If you don't want emails from this sender, you can add them to your unwanted list — future ones will go to Trash automatically.",
        "check.advice_subscription": "This looks like a subscription. You can review or cancel it on the Subscriptions page, where FeeHunt walks you through it step by step.",
        "check.advice_caution": "Don't click any links or share details. If you don't want emails from this sender, you can add them to your unwanted list so future ones go to Trash.",
        "check.open_sender_mgmt": "Open Sender management →",
        "check.open_subscriptions": "Open Subscriptions →",
    ...
    "lt": {
        ...
        "check.manual_heading": "Patikrink laišką pats",
        ...
        "check.sender_about": "Apie šį siuntėją",
        "check.sender_domain": "Laiškas tikrai atėjo iš domeno **{domain}**.",
        "check.sender_legit": "Tai oficialus **{brand}** domenas — atrodo tikra.",
        "check.sender_personal": "Tai asmeninė pašto dėžutė ({domain}) — laišką siuntė žmogus, ne įmonė. Vertink pagal turinį.",
        "check.sender_unknown": "FeeHunt neturi šio siuntėjo savo žinomų prekės ženklų sąraše, todėl negali patvirtinti, kad tai oficialus **{name}**. Bet adrese nematyti apsimetinėjimo ar suklastoto domeno. Jei abejoji — eik tiesiai į oficialią svetainę pats, o ne per laiško nuorodas.",
        "check.sender_caution": "Pats adresas turi įtartinų požymių (žr. aukščiau) — būk atsargus.",
        "check.advice_heading": "💡 Ką gali daryti",
        "check.advice_promotional": "Tai panašu į reklaminį laišką. Jei nenori laiškų iš šio siuntėjo, gali įtraukti jį į nepageidaujamų sąrašą — ateityje jie automatiškai keliausis į šiukšlinę.",
        "check.advice_subscription": "Tai panašu į prenumeratą. Ją gali peržiūrėti ar atšaukti Prenumeratų skiltyje — ten FeeHunt praveda žingsnis po žingsnio.",
        "check.advice_caution": "Nespausk jokių nuorodų ir nedalink duomenų. Jei nenori laiškų iš šio siuntėjo, gali įtraukti jį į nepageidaujamų sąrašą, kad ateityje keliautų į šiukšlinę.",
        "check.open_sender_mgmt": "Atidaryti Siuntėjų valdymą →",
        "check.open_subscriptions": "Atidaryti Prenumeratas →",
...
MEMORY_TRANSLATIONS = {
    "en": {
        ...
        "memory.enabled_adaptive": "Use adaptive guidance",
    ...
    "lt": {
        ...
        "memory.enabled_adaptive": "Naudoti prisitaikančią pagalbą",
...
READINESS_TRANSLATIONS = {
    "en": {
        ...
        "license.deactivate": "Sign out of FeeHunt",
    ...
    "lt": {
        ...
        "license.deactivate": "Atsijungti nuo FeeHunt",
...
CONTEXTUAL_HELP = {
    "en": {
        ...
        "direct_cancel": "Open the cancellation link FeeHunt found inside this email. FeeHunt does not cancel for you.",
...
AUTO_SCAN_ALIASES = {
    ...
    "daily": "daily",
    "kartą per savaitę": "weekly",
    "karta per savaite": "weekly",
    "weekly": "weekly",
}
